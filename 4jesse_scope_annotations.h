/* date = July 26th 2021 7:13 pm */

#ifndef FOURJESSE_SCOPE_ANNOTATION_H
#define FOURJESSE_SCOPE_ANNOTATION_H

//NOTE(Jesse): This is a modified version of https://4coder.handmade.network/wiki/7394-%5Bmodule%5D_vertical_scope_annotation
// The modifications were in the way it was renderered
/*
# Description
...
function void vertical_scope_annotation_draw( Application_Links *app, View_ID view, Buffer_ID buffer, Text_Layout_ID text_layout_id, u32 flags ) {
    ...
    i64 indent_space_count = def_get_config_u64( app, vars_save_string_lit( "indent_width" ) );
...
#endif //4JESSE_SCOPE_ANNOTATION_H
